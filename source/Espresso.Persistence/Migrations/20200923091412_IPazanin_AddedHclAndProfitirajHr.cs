...
{
    public partial class IPazanin_AddedHclAndProfitirajHr : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 151, 5, 106, 1, "https://www.hcl.hr/feed", "//div[contains(@class, 'article')]//img", 0, 7 });

            migrationBuilder.InsertData(
                table: "RssFeeds",
                columns: new[] { "Id", "CategoryId", "NewsPortalId", "RequestType", "Url", "ImageUrlParseConfiguration_ImgElementXPath", "SkipParseConfiguration_CurrentSkip", "SkipParseConfiguration_NumberOfSkips" },
                values: new object[] { 152, 7, 107, 1, "https://profitiraj.hr/feed", "//div[contains(@class, 'site-content')]//img", 0, 11 });
        }
