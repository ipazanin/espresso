    ...
    public partial class IPazanin_InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object?[,]
                {
                    { 7, "Slavonija & Baranja", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt" },
                    { 1, "Global", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt" },
                    { 2, "Dalmacija", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt" },
                    { 3, "Istra & Kvarner", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt" },
                    { 4, "Lika", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt" },
                    { 6, "Sjeverna Hrvatska", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt" },
                    { 5, "Zagreb", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object?[,]
                {
                    { 71, 1, 32, "https://100posto.jutarnji.hr/rss", 2, 1, 1, "//picture[contains(@class, 'pic')]//img", null, 0, 5 },
                    { 70, 3, 31, "https://www.hrt.hr/rss/glazba/", 1, 1, 1, "//div[contains(@class, 'image-slider')]//img", null, 0, 5 },
                    { 69, 3, 31, "https://magazin.hrt.hr/feed.xml", 1, 1, 1, "//div[contains(@class, 'image-slider')]//img", null, 0, 5 },
                    { 68, 2, 31, "https://www.hrt.hr/rss/sport/", 1, 1, 1, "//div[contains(@class, 'image-slider')]//img", null, 0, 5 },
                    { 67, 1, 31, "https://www.hrt.hr/rss/vijesti/", 1, 1, 1, "//div[contains(@class, 'image-slider')]//img", null, 0, 5 }
                });
            ...
            migrationBuilder.InsertData(
                table: "RssFeeds",
                columns: new[] { "Id", "CategoryId", "NewsPortalId", "Url", "AmpConfiguration_HasAmpArticles", "AmpConfiguration_TemplateUrl", "CategoryParseConfiguration_CategoryParseStrategy", "ImageUrlParseConfiguration_ImageUrlParseStrategy", "ImageUrlParseConfiguration_ImageUrlWebScrapeType", "ImageUrlParseConfiguration_ImgElementXPath", "ImageUrlParseConfiguration_JsonWebScrapePropertyNames" },
                values: new object?[] { 57, 5, 21, "http://www.netokracija.com/feed", true, "https://www.netokracija.com/{1}/amp", 1, 1, 1, "//div[contains(@class, 'post__hero')]//img", null });
            ...
            migrationBuilder.InsertData(
                table: "RssFeeds",
                columns: new[] { "Id", "CategoryId", "NewsPortalId", "Url", "AmpConfiguration_HasAmpArticles", "AmpConfiguration_TemplateUrl", "CategoryParseConfiguration_CategoryParseStrategy", "ImageUrlParseConfiguration_ImageUrlParseStrategy", "ImageUrlParseConfiguration_ImageUrlWebScrapeType", "ImageUrlParseConfiguration_ImgElementXPath", "ImageUrlParseConfiguration_JsonWebScrapePropertyNames" },
                values: new object?[] { 56, 5, 20, "https://zimo.dnevnik.hr/assets/feed/articles", true, "https://zimo.dnevnik.hr/amp/clanak/{2}", 1, 1, 1, "//div[contains(@class, 'img-holder')]//img", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object?[,]
                {
                    ...
                    { 105, 12, 59, "https://ivijesti.hr/feed", 1, 1, 1, "", null },
                    { 91, 12, 45, "https://www.parentium.com/rssfeed.asp", 1, 1, 1, "", null },
                    { 90, 12, 44, "https://www.novilist.hr/feed", 1, 1, 1, "", null },
                    { 87, 12, 41, "https://dalmatinskiportal.hr/sadrzaj/rss/vijesti.xml", 1, 1, 1, "", null },
                    { 86, 12, 40, "https://www.dalmacijanews.hr/rss", 1, 1, 1, "", null },
                    { 83, 12, 37, "https://www.dalmacijadanas.hr/feed/", 1, 1, 1, "//div[contains(@class, 'td-full-screen-header-image-wrap')]//img", null }
                });

            migrationBuilder.InsertData(
                table: "RssFeeds",
                columns: new[] { "Id", "CategoryId", "NewsPortalId", "Url", "CategoryParseConfiguration_CategoryParseStrategy", "ImageUrlParseConfiguration_ImageUrlParseStrategy", "ImageUrlParseConfiguration_ImageUrlWebScrapeType", "ImageUrlParseConfiguration_ImgElementXPath", "ImageUrlParseConfiguration_JsonWebScrapePropertyNames", "SkipParseConfiguration_CurrentSkip", "SkipParseConfiguration_NumberOfSkips" },
                values: new object?[] { 85, 1, 39, "https://express.24sata.hr/feeds/placeholder-head/rss_feed", 2, 1, 1, "//img[contains(@class, 'article__figure_img')]", null, 0, 10 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object?[,]
                {
                    { 84, 1, 38, "https://www.nacional.hr/feed/", 1, 1, 1, "//div[contains(@class, 'single-post-media')]//img", null },
                    { 82, 1, 36, "https://www.scena.hr/feed/", 2, 1, 1, "//div[contains(@class, 'mycontent')]//img", null },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object?[,]
                {
                    { 13, 1, 4, "https://www.jutarnji.hr/feed", 2, 1, 1, "//img[contains(@class, 'media-object adaptive lazy')]", null, 0, 5 },
            ...
            migrationBuilder.InsertData(
                table: "RssFeeds",
                columns: new[] { "Id", "CategoryId", "NewsPortalId", "Url", "CategoryParseConfiguration_CategoryParseStrategy", "ImageUrlParseConfiguration_ImageUrlParseStrategy", "ImageUrlParseConfiguration_ImageUrlWebScrapeType", "ImageUrlParseConfiguration_ImgElementXPath", "ImageUrlParseConfiguration_JsonWebScrapePropertyNames" },
                values: new object?[] { 97, 12, 51, "https://www.zagreb.info/feed", 1, 1, 1, "", null });
            ...
            migrationBuilder.InsertData(
                table: "RssFeeds",
                columns: new[] { "Id", "CategoryId", "NewsPortalId", "Url", "CategoryParseConfiguration_CategoryParseStrategy", "ImageUrlParseConfiguration_ImageUrlParseStrategy", "ImageUrlParseConfiguration_ImageUrlWebScrapeType", "ImageUrlParseConfiguration_ImgElementXPath", "ImageUrlParseConfiguration_JsonWebScrapePropertyNames", "SkipParseConfiguration_CurrentSkip", "SkipParseConfiguration_NumberOfSkips" },
                values: new object?[] { 24, 4, 6, "https://www.slobodnadalmacija.hr/feed/category/268", 1, 1, 1, "//img[contains(@class, 'card__image')]", null, 0, 5 });
